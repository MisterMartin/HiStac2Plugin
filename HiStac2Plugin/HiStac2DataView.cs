    ...
    public partial class HiStac2DataView : UserControl
    {
                    ...
                    )
        {
            ...
            else
            {
                ...
                STAC2_VBatLabel.Text          = string.Format("{0:0.00} [V]",     STAC2_VBat);
                STAC2_SaturatorTempLabel.Text = string.Format("{0:0.0} [deg C]",  STAC2_SatTemp);
                STAC2_CondenserTempLabel.Text = string.Format("{0:0.0} [deg C]",  STAC2_CondenserTemp);

                HI_UpstreamTempLabel.Text     = string.Format("{0:0.0} [deg C]",  HI_UpstreamTemp);
                HI_MidstreamTempLabel.Text    = string.Format("{0:0.0} [deg C]",  HI_MidstreamTemp);
                HI_DownstreamTempLabel.Text   = string.Format("{0:0.0} [deg C]",  HI_DownstreamTemp);
                HI_BatVLabel.Text             = string.Format("{0:0.00} [V]",     HI_VBat);
            }
        }
    }
}
